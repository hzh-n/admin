...
;!function (d) {
    ...
    var t, h = d.document, m = {modules: {}, status: {}, timeout: 10, event: {}}, n = function () {
        ...
        for (var t, e = h.scripts, r = e.length - 1, n = r; 0 < n; n--) if ("interactive" === e[n].readyState) {
            t = e[n].src;
            break
        }
        return t || e[r].src
        ...
        var o = this, i = m.dir = m.dir || v, a = h.getElementsByTagName("head")[0],
            u = (r = "string" == typeof r ? [r] : "function" == typeof r ? (t = r, ["all"]) : r, d.jQuery && jQuery.fn.on && (o.each(r, function (t, e) {
                "jquery" === e && r.splice(t, 1)
            }), layui.jquery = layui.$ = jQuery), r[0]), l = 0;

        function s(t, e) {
            var r = "PLaySTATION 3" === navigator.platform ? /^complete$/ : /^(complete|loaded)$/;
            "load" !== t.type && !r.test((t.currentTarget || t.srcElement).readyState) || (m.modules[u] = e, a.removeChild(p), function n() {
                return ++l > 1e3 * m.timeout / 4 ? g(u + " is not a valid module", "error") : void (m.status[u] ? c() : setTimeout(n, 4))
            }())
        }

        function c() {
            e.push(layui[u]), 1 < r.length ? o.use(r.slice(1), t, e, n) : "function" == typeof t && (layui.jquery && "function" == typeof layui.jquery && "define" !== n ? layui.jquery(function () {
                t.apply(layui, e)
            }) : t.apply(layui, e))
        }

        if (e = e || [], m.host = m.host || (i.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === r.length || layui["layui.all"] && N[u]) return c(), o;
        var p,
            y = (y = (N[u] ? i + "modules/" : !/^\{\/\}/.test(o.modules[u]) && m.base || "") + (o.modules[u] || u) + ".js").replace(/^\{\/\}/, "");
        ...
        return t = r.isArray(t) ? t : [t], r.each(t, function (t, e) {
            m.status[e], delete r[e], delete N[e], delete r.modules[e], delete m.status[e], delete m.modules[e]
        }), r
        ...
        var o = this, e = h.getElementsByTagName("head")[0], i = h.createElement("link"),
            t = ((t = "string" == typeof n ? n : t) || r).replace(/\.|\//g, ""), a = i.id = "layuicss-" + t,
            u = "creating", l = 0;
        return i.rel = "stylesheet", i.href = r + (m.debug ? "?v=" + (new Date).getTime() : ""), i.media = "all", h.getElementById(a) || e.appendChild(i), "function" != typeof n || function s(t) {
            var e = h.getElementById(a);
            return ++l > 1e3 * m.timeout / 100 ? g(r + " timeout") : void (1989 === parseInt(o.getStyle(e, "width")) ? (t === u && e.removeAttribute("lay-status"), e.getAttribute("lay-status") === u ? setTimeout(s, 100) : n()) : (e.setAttribute("lay-status", u), setTimeout(function () {
                s(u)
            }, 100)))
        }(), o
        ...
        var r = {path: [], search: {}, hash: ((t = t || location.hash).match(/[^#](#.*$)/) || [])[1] || ""};
        return /^#\//.test(t) && (t = t.replace(/^#\//, ""), r.href = "/" + t, t = t.replace(/([^#])(#.*$)/, "$1").split("/") || [], this.each(t, function (t, e) {
        ...
        return {
            ...
            search: (o = {}, e = (t ? ((t.match(/\?.+/) || [])[0] || "").replace(/\#.+/, "") : location.search).replace(/^\?+/, "").split("&"), r.each(e, function (t, e) {
                var r = e.indexOf("="), n = r < 0 ? e.substr(0, e.length) : 0 !== r && e.substr(0, r);
        ...
        if (t = t || "layui", r = r || localStorage, d.JSON && d.JSON.parse) {
            ...
            return "value" in e && (n[e.key] = e.value), e.remove && delete n[e.key], r[t] = JSON.stringify(n), e.key ? n[e.key] : n
        }
    }, n.prototype.sessionData = function (t, e) {
        return this.data(t, e, sessionStorage)
    }, n.prototype.device = function (t) {
        var r = navigator.userAgent.toLowerCase(), e = function (t) {
            var e = new RegExp(t + "/([^\\s\\_\\-]+)");
            return (t = (r.match(e) || [])[1]) || !1
        }, n = {
            os: /windows/.test(r) ? "windows" : /linux/.test(r) ? "linux" : /iphone|ipod|ipad|ios/.test(r) ? "ios" : /mac/.test(r) ? "mac" : void 0,
            ie: !!(d.ActiveXObject || "ActiveXObject" in d) && ((r.match(/msie\s(\d+)/) || [])[1] || "11"),
            weixin: e("micromessenger")
        };
        return t && !n[t] && (n[t] = e(t)), n.android = /android/.test(r), n.ios = "ios" === n.os, n.mobile = !(!n.android && !n.ios), n
        ...
        var e, r = this.type(t);
        return !(!t || "object" != typeof t || t === d) && (e = "length" in t && t.length, "array" === r || 0 === e || "number" == typeof e && 0 < e && e - 1 in t)
    }, n.prototype.each = function (t, r) {
        var e, n = function (t, e) {
            return r.call(e[t], t, e[t])
        };
        if ("function" != typeof r) return this;
        if (this.isArray(t = t || [])) for (e = 0; e < t.length && !n(e, t); e++) ; else for (e in t) if (n(e, t)) break;
        return this
        ...
        return "object" !== this.type(t) || o ? "object" != typeof t ? [r] : (r.sort(function (t, e) {
            ...
            t = [!isNaN(r), !isNaN(n)];
            return t[0] && t[1] ? r && !n && 0 !== n ? 1 : !r && 0 !== r && n ? -1 : r - n : t[0] || t[1] ? t[0] || !t[1] ? -1 : !t[0] || t[1] ? 1 : void 0 : n < r ? 1 : r < n ? -1 : 0
        }), e && r.reverse(), r) : r
    ...
    n.prototype.onevent = function (t, e, r) {
        ...
        var o = this, i = null, a = (e || "").match(/\((.*)\)$/) || [], t = (t + "." + e).replace(a[0], ""),
            u = a[1] || "", l = function (t, e) {
                !1 === (e && e.call(o, r)) && null === i && (i = !1)
            };
        return r === s ? (delete (o.cache.event[t] || {})[u], o) : n ? (m.event[t] = m.event[t] || {}, u ? m.event[t][u] = [n] : (m.event[t][u] = m.event[t][u] || [], m.event[t][u].push(n)), this) : (layui.each(m.event[t], function (t, e) {
...
!function (l) {
    ...
    (r.prototype = []).constructor = r, h.extend = function () {
        ...
        }, i = u.left, c = u.bottom, "center" === n.align ? i -= (a - t.offsetWidth) / 2 : "right" === n.align && (i = i - a + t.offsetWidth), (i = i + a + 5 > (r = function (t) {
            return f.documentElement[t ? "clientWidth" : "clientHeight"]
        })("width") ? r("width") - a - 5 : i) < 5 && (i = 5), c + s + 5 > r() && (u.top > s + 5 ? c = u.top - s - 10 : "right" === n.clickType ? (c = r() - s - 10) < 0 && (c = 0) : c = 5), (a = n.position) && (e.style.position = a), e.style.left = i + ("fixed" === a ? 0 : o(1)) + "px", e.style.top = c + ("fixed" === a ? 0 : o()) + "px", h.hasScrollbar() || (s = e.getBoundingClientRect(), !n.SYSTEM_RELOAD && s.bottom + 5 > r() && (n.SYSTEM_RELOAD = !0, setTimeout(function () {
            h.position(t, e, n)
        }, 50))))
    }, h.options = function (t, e) {
        e = "object" == typeof e ? e : {attr: e};
        var t = h(t), n = e.attr || "lay-options", t = t.attr(n);
        try {
        ...
        var r = this, i = 0, c = [], u = "object" == typeof o;
...
!function (i, p) {
    ...
    var n = i.layui && layui.define, l = {
            ...
            ready: function (e) {
                var t = "laydate", a = (n ? "modules/" : "") + "laydate.css?v=" + v.v;
        ...
        }, a = "laydate", x = "layui-this", k = "laydate-disabled", h = [100, 2e5], D = "layui-laydate-static",
        w = "layui-laydate-list", o = "laydate-selected", r = "layui-laydate-hint", s = "laydate-day-prev",
        y = "laydate-day-next", C = ".laydate-btns-confirm", M = "laydate-time-text", E = "laydate-btns-time",
        T = "layui-laydate-preview", L = "layui-laydate-main", S = "layui-laydate-shade", I = function (e) {
            var t = this,
                a = (t.index = ++v.index, t.config = lay.extend({}, t.config, v.config, e), lay(e.elem || t.config.elem));
    ...
    d.formatArr = function (e) {
        ...
        var e, r = this, o = r.config, t = "static" === o.position,
            a = {year: "yyyy", month: "yyyy-MM", date: "yyyy-MM-dd", time: "HH:mm:ss", datetime: "yyyy-MM-dd HH:mm:ss"};
        o.elem = lay(o.elem), o.eventElem = lay(o.eventElem), o.elem[0] && ((e = d.that[o.elem.attr("lay-key")]) && e.destroy && e.destroy(), "array" !== layui.type(o.theme) && (o.theme = [o.theme]), o.fullPanel && ("datetime" !== o.type || o.range) && delete o.fullPanel, r.rangeStr = o.range ? "string" == typeof o.range ? o.range : "-" : "", r.rangeLinked = !(!o.range || !o.rangeLinked || "date" !== o.type && "datetime" !== o.type), r.autoCalendarModel = function () {
            var e = r.rangeLinked;
            ...
            e = new RegExp(m).test(t) ? "\\d{" + (new RegExp(m).test(r.format[0 === e ? e + 1 : e - 1] || "") ? /^yyyy|y$/.test(t) ? 4 : t.length : /^yyyy$/.test(t) ? "1,4" : /^y$/.test(t) ? "1,308" : "1,2") + "}" : "\\" + t;
            r.EXP_IF = r.EXP_IF + e, r.EXP_SPLIT = r.EXP_SPLIT + "(" + e + ")"
        }), r.EXP_IF_ONE = new RegExp("^" + r.EXP_IF + "$"), r.EXP_IF = new RegExp("^" + (o.range ? r.EXP_IF + "\\s\\" + r.rangeStr + "\\s" + r.EXP_IF : r.EXP_IF) + "$"), r.EXP_SPLIT = new RegExp("^" + r.EXP_SPLIT + "$", ""), r.isInput(o.elem[0]) || "focus" === o.trigger && (o.trigger = "click"), o.elem.attr("lay-key", r.index), o.eventElem.attr("lay-key", r.index), o.mark = lay.extend({}, o.calendar && "cn" === o.lang ? {
            "0-1-1": "\u5143\u65e6",
            "0-2-14": "\u60c5\u4eba",
            "0-3-8": "\u5987\u5973",
            "0-3-12": "\u690d\u6811",
            ...
            l = "number" == typeof o[t] ? (a = o[t], n = new Date, n = r.newDate({
                ...
                minutes: e ? 59 : 0,
                seconds: e ? 59 : 0
            }).getTime(), i = [(e = new Date(a ? a < 864e5 ? n + 864e5 * a : a : n)).getFullYear(), e.getMonth() + 1, e.getDate()], [e.getHours(), e.getMinutes(), e.getSeconds()]) : (i = (o[t].match(/\d+-\d+-\d+/) || [""])[0].split("-"), (o[t].match(/\d+:\d+:\d+/) || [""])[0].split(":")), o[t] = {
        ...
        }), r.elemID = "layui-laydate" + o.elem.attr("lay-key"), (o.show || t) && r.render(), t || r.events(), o.value && o.isInitValue && ("date" === layui.type(o.value) ? r.setValue(r.parse(0, r.systemDate(o.value))) : r.setValue(o.value)))
    }, I.prototype.render = function () {
        var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position,
            y = r.elem = lay.elem("div", {
                id: r.elemID,
                "class": ["layui-laydate", o.range ? " layui-laydate-range" : "", r.rangeLinked ? " layui-laydate-linkage" : "", s ? " " + D : "", o.fullPanel ? " laydate-theme-fullpanel" : "", (a = "", lay.each(o.theme, function (e, t) {
            ...
            f = (o.zIndex && (y.style.zIndex = o.zIndex), lay.each(new Array(2), function (e) {
                ...
                }), i.insertBefore(l, i.children[0]), n.appendChild(i), m[e] = lay.elem("div", {"class": L + " laydate-main-list-" + e}), m[e].appendChild(a), m[e].appendChild(n), c.push(t), u.push(n), h.push(i)
            }), lay(e).html((f = [], n = [], "datetime" === o.type && f.push('<span lay-type="datetime" class="' + E + '">' + d.timeTips + "</span>"), (o.range || "datetime" !== o.type || o.fullPanel) && f.push('<span class="' + T + '" title="' + d.preview + '"></span>'), lay.each(o.btns, function (e, t) {
                var a = d.tools[t] || "btn";
                ...
                var t = (o.shortcuts[this.dataset.index] || {}).value || [],
                    ...
                    }), r.checkDate("limit").calendar(null, null, "init"), lay(r.footer).find("." + E).removeClass(k));
                t && "date" === t.attr("lay-type") && t[0].click(), r.done(null, "change"), lay(this).addClass(x), "static" !== o.position && !o.range && o.autoConfirm && ("date" === n ? r.choose(lay(y).find("td.layui-this")) : "year" !== n && "month" !== n || lay(m[0]).find("." + L + " li." + x + ":not(.laydate-disabled)")[0] && r.setValue(r.parse()).done().remove())
            })), lay.each(m, function (e, t) {
                y.appendChild(t)
            }), o.showBottom && y.appendChild(e), lay.elem("style")), g = [], t = (lay.each(o.theme, function (e, t) {
                /^#/.test(t) && (l = !0, g.push(["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} li.layui-this,#{{id}} td.layui-this>div{background-color:{{theme}} !important;}", -1 !== o.theme.indexOf("circle") ? "" : "#{{id}} .layui-this{background-color:{{theme}} !important;}"].join("").replace(/{{id}}/g, r.elemID).replace(/{{theme}}/g, t)))
            }), o.shortcuts && o.range && g.push("#{{id}}.layui-laydate-range{width: 628px;}".replace(/{{id}}/g, r.elemID)), g.length && (g = g.join(""), "styleSheet" in f ? (f.setAttribute("type", "text/css"), f.styleSheet.cssText = g) : f.innerHTML = g, l && lay(y).addClass("laydate-theme-molv"), y.appendChild(f)), r.remove(I.thisElemDate), v.thisId = o.id, s ? o.elem.append(y) : (p.body.appendChild(y), r.position()), o.shade ? '<div class="' + S + '" style="z-index:' + (y.style.zIndex - 1) + "; background-color: " + (o.shade[1] || "#000") + "; opacity: " + (o.shade[0] || o.shade) + '"></div>' : "");
        ...
        return n[0] && (n.hasClass(D) || t.checkDate(function () {
            n.remove(), delete t.startDate, delete t.endDate, delete t.endState, delete t.startTime, delete t.endTime, delete v.thisId, "function" == typeof a.close && a.close(t)
        }), lay("." + S).remove()), t
        ...
        t.elem && (a.innerHTML = e || "", lay(t.elem).find("." + r).remove(), t.elem.appendChild(a), clearTimeout(t.hinTimer), t.hinTimer = setTimeout(function () {
        ...
        var t, o, d = this, s = (new Date, d.config), a = d.lang(), n = s.dateTime = s.dateTime || d.systemDate(),
            i = d.bindElem || s.elem[0], l = (d.isInput(i), function () {
                if (d.rangeElem) {
                ...
                e && (e.year > h[1] && (e.year = h[1], o = !0), 11 < e.month && (e.month = 11, o = !0), 59 < e.seconds && (e.seconds = 0, e.minutes++, o = !0), 59 < e.minutes && (e.minutes = 0, e.hours++, o = !0), 23 < e.hours && (e.hours = 0, o = !0), t = v.getEndDate(e.month + 1, e.year), e.date > t && (e.date = t, o = !0))
            }, r = function (n, i, l) {
        ...
        }), c && l && (d.setValue(d.parse()), d.hint("value " + a.invalidDate + a.formatError[1])), d.startDate = d.startDate || l && lay.extend({}, s.dateTime), d.autoCalendarModel.auto && d.autoCalendarModel(), d.endState = !s.range || !d.rangeLinked || !(!d.startDate || !d.endDate), e && e(), d
        ...
        var i, l, r, o = this, n = o.config, t = t ? 1 : 0, d = e || o.thisDateTime(t), s = new Date, y = o.lang(),
            m = "date" !== n.type && "datetime" !== n.type, c = lay(o.table[t]).find("td"),
            u = lay(o.elemHeader[t][2]).find("span");
        return d.year < h[0] && (d.year = h[0], o.hint(y.invalidDate)), d.year > h[1] && (d.year = h[1], o.hint(y.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, d)), s.setFullYear(d.year, d.month, 1), i = (s.getDay() + (7 - n.weekStart)) % 7, l = v.getEndDate(d.month || 12, d.year), r = v.getEndDate(d.month + 1, d.year), lay.each(c, function (e, t) {
            ...
            (t = lay(t)).removeAttr("class"), e < i ? (n = l - i + e, t.addClass("laydate-day-prev"), a = o.getAsYM(d.year, d.month, "sub")) : i <= e && e < r + i ? (n = e - i, o.rangeLinked || n + 1 === d.date && t.addClass(x)) : (n = e - r - i, t.addClass("laydate-day-next"), a = o.getAsYM(d.year, d.month)), a[1]++, a[2] = n + 1, t.attr("lay-ymd", a.join("-")).html("<div>" + a[2] + "</div>"), o.mark(t, a).holidays(t, a).limit({
                elem: t,
                date: {year: a[0], month: a[1] - 1, date: a[2]},
                index: e
            })
        ...
        var l, r, e, o, d = this, s = d.config, y = d.rangeLinked ? s.dateTime : [s.dateTime, d.endDate][i],
            ...
            g = "cn" === s.lang, p = g ? "\u5e74" : "", v = d.listYM[i] || {}, D = ["hours", "minutes", "seconds"],
        ...
        return v[0] < 1 && (v[0] = 1), "year" === n ? (e = l = v[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function (e) {
            ...
            l == v[0] && lay(t).addClass(x), t.innerHTML = l + p, c.appendChild(t), d.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n
            }), l++
        }), lay(u[g ? 0 : 1]).attr("lay-ym", l - 8 + "-" + v[1]).html(e + p + " - " + (l - 1) + p)) : "month" === n ? (lay.each(new Array(12), function (e) {
            var t = lay.elem("li", {"lay-ym": e}), a = {year: v[0], month: e, date: 1};
            e + 1 == v[1] && lay(t).addClass(x), t.innerHTML = m.month[e] + (g ? "\u6708" : ""), c.appendChild(t), d.limit({
                elem: lay(t),
                date: a,
                index: i,
                type: n
            })
        }), lay(u[g ? 0 : 1]).attr("lay-ym", v[0] + "-" + v[1]).html(v[0] + p)) : "time" === n && (r = function () {
            ...
            }) : y[n] = e, "year" === s.type || "month" === s.type ? (lay(c).find("." + x).removeClass(x), lay(this).addClass(x), "month" === s.type && "year" === n && (d.listYM[i][0] = e, t && ((i ? d.endDate : y).year = e), d.list("month", i))) : (d.checkDate("limit").calendar(y, i, "init"), d.closeList()), d.setBtnStatus(), !s.range && s.autoConfirm && ("month" === s.type && "month" === n || "year" === s.type && "year" === n) && d.setValue(d.parse()).done().remove(), d.autoCalendarModel.auto && !d.rangeLinked ? d.choose(lay(h).find("td.layui-this"), i) : d.endState && d.done(null, "change"), lay(d.footer).find("." + E).removeClass(k))
        ...
        a.isPreview && (e = lay(t.elem).find("." + T), a = !a.range || (t.rangeLinked ? t.endState : t.endDate) ? t.parse() : "", e.html(a), e.html() && (e.css({color: "#5FB878"}), setTimeout(function () {
            e.css({color: "#777"})
        }, 300)))
        ...
        l.range && !i.endState && lay(i.footer).find(C).addClass(k), r = r && i.newDate({
            ...
            l.rangeLinked && !i.startDate && a === i.newDate(i.systemDate()).getTime() && lay(t).addClass(lay(t).hasClass(s) || lay(t).hasClass(y) ? "" : "laydate-day-now"), lay(t).removeClass(o + " " + x), a !== r && a !== n || (i.rangeLinked || !i.rangeLinked && (e < 42 ? a === r : a === n)) && lay(t).addClass(lay(t).hasClass(s) || lay(t).hasClass(y) ? o : x), r < a && a < n && lay(t).addClass(o)
        })
        ...
        var a = this, n = a.config, i = a.lang(), l = n.dateTime, r = "static" === n.position, o = {
            datetime: function () {
                ...
                r && (lay.extend(l, a.firstDate), a.calendar()), n.range && (delete n.dateTime, delete a.endDate, delete a.startTime, delete a.endTime), a.setValue(""), a.done(["", {}, {}]).remove()
            }, now: function () {
                var e = new Date;
                ...
                }), a.setValue(a.parse()), r && a.calendar(), a.done().remove()
            }, confirm: function () {
                if (n.range) {
        ...
        lay(i.elem).on("click", function (e) {
            ...
            lay(e[0]).on("click", function (e) {
                ...
                a && (a = a.split("-"), i.listYM[n] = [0 | a[0], 0 | a[1]], i.list(t, n), lay(i.footer).find("." + E).addClass(k))
        ...
        a.elem[0] && !a.elem[0].eventHandler && (a.elem.on(a.trigger, e = function () {
            ...
            t.remove(), a.elem.off(a.trigger, e), a.elem.removeAttr("lay-key"), a.elem[0].eventHandler = !1, a.eventElem.off(a.trigger, e), a.eventElem.removeAttr("lay-key"), delete d.that[a.id]
        })
    }, d.that = {}, d.getThis = function (e) {
        var t = d.that[e];
        return !t && n && layui.hint().error(e ? a + " instance with ID '" + e + "' not found" : "ID argument required"), t
    }, l.run = function (n) {
        n(p).on("mousedown", function (e) {
            var t, a;
            !v.thisId || (t = d.getThis(v.thisId)) && (a = t.config, e.target !== a.elem[0] && e.target !== a.eventElem[0] && e.target !== n(a.closeStop)[0] && t.remove())
        }).on("keydown", function (e) {
            var t;
            !v.thisId || (t = d.getThis(v.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === I.thisElemDate && (e.preventDefault(), n(t.footer).find(C)[0].click())
        ...
        return a = a || {}, n = ((n = "string" == typeof n ? d.formatArr(n) : n) || []).concat(), lay.each(n, function (e, t) {
...
!function (p) {
    "use strict";
    var m, c, e, n = p.layui && layui.define, f = {
            ...
            link: function (e, i, t) {
                ...
                h.path && (n = document.getElementsByTagName("head")[0], a = document.createElement("link"), o = ((t = "string" == typeof i ? i : t) || e).replace(/\.|\//g, ""), s = "layuicss-" + o, l = "creating", r = 0, a.rel = "stylesheet", a.href = h.path + e, a.id = s, document.getElementById(s) || n.appendChild(a), "function" == typeof i && function c(e) {
                    ...
                    return 100 < ++r ? p.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(f.getStyle(t, "width")) ? (e === l && t.removeAttribute("lay-status"), t.getAttribute("lay-status") === l ? setTimeout(c, 100) : i()) : (t.setAttribute("lay-status", l), setTimeout(function () {
                        c(l)
                    }, 100)))
                }())
            }
            ...
            path: f.getPath,
            config: function (e, t) {
                return h.cache = f.config = m.extend({}, f.config, e = e || {}), h.path = f.config.path || h.path, "string" == typeof e.extend && (e.extend = [e.extend]), f.config.path && h.ready(), e.extend && (n ? layui.addcss("modules/layer/" + e.extend) : f.link("css/" + e.extend)), this
            },
            ready: function (e) {
            ...
            confirm: function (e, t, i, n) {
                ...
                return a && (n = i, i = t), h.open(m.extend({content: e, btn: f.btn, yes: i, btn2: n}, a ? {} : t))
            },
            msg: function (e, t, i) {
                var n = "function" == typeof t, a = f.config.skin, a = (a ? a + " " + a + "-msg" : "") || "layui-layer-msg",
                    o = d.anim.length - 1;
                return n && (i = t), h.open(m.extend({
                    ...
                    anim: o
                } : (-1 !== (t = t || {}).icon && (void 0 !== t.icon || f.config.skin) || (t.skin = a + " " + (t.skin || "layui-layer-hui")), t)))
            },
            load: function (e, t) {
            ...
            t.index = ++h.index, t.config.maxWidth = m(c).width() - 30, t.config = m.extend({}, t.config, f.config, e), document.body ? i() : setTimeout(function () {
                i()
            }, 30)
        },
        ...
        i = (d.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], d.SHADE = "layui-layer-shade", d.MOVE = "layui-layer-move", t.pt.config = {
            ...
            return a.zIndex = o, t([a.shade ? '<div class="' + d.SHADE + '" id="' + d.SHADE + n + '" times="' + n + '" style="z-index:' + (o - 1) + '; "></div>' : "", '<div class="' + d[0] + " layui-layer-" + f.type[a.type] + (0 != a.type && 2 != a.type || a.shade ? "" : " layui-layer-border") + " " + (a.skin || "") + '" id="' + d[0] + n + '" type="' + f.type[a.type] + '" times="' + n + '" showtime="' + a.time + '" conType="' + (e ? "object" : "string") + '" style="z-index: ' + o + "; width:" + a.area[0] + ";height:" + a.area[1] + ";position:" + (a.fixed ? "fixed;" : "absolute;") + '">' + (e && 2 != a.type ? "" : s) + "<div" + (a.id ? ' id="' + a.id + '"' : "") + ' class="layui-layer-content' + (0 == a.type && -1 !== a.icon ? " layui-layer-padding" : "") + (3 == a.type ? " layui-layer-loading" + a.icon : "") + '">' + (n = ["layui-icon-tips", "layui-icon-ok", "layui-icon-close-fill", "layui-icon-help", "layui-icon-password", "layui-icon-face-cry", "layui-icon-face-smile"], o = "layui-anim layui-anim-rotate layui-anim-loop", 0 == a.type && -1 !== a.icon ? '<i class="layui-layer-face layui-icon ' + ((i = 16 == a.icon ? "layui-icon layui-icon-loading " + o : i) || n[a.icon] || n[0]) + '"></i>' : 3 == a.type ? (i = ["layui-icon-loading", "layui-icon-loading-1"], 2 == a.icon ? '<div class="layui-layer-loading-2 ' + o + '"></div>' : '<i class="layui-layer-loading-icon layui-icon ' + (i[a.icon] || i[0]) + " " + o + '"></i>') : "") + ((1 != a.type || !e) && a.content || "") + '</div><div class="layui-layer-setwin">' + (n = [], l && (n.push('<span class="layui-layer-min"></span>'), n.push('<span class="layui-layer-max"></span>')), a.closeBtn && n.push('<span class="layui-icon layui-icon-close ' + [d[7], d[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2")].join(" ") + '"></span>'), n.join("")) + "</div>" + (a.btn ? function () {
                var e = "";
                "string" == typeof a.btn && (a.btn = [a.btn]);
                for (var t = 0, i = a.btn.length; t < i; t++) e += '<a class="' + d[6] + t + '">' + a.btn[t] + "</a>";
                return '<div class="' + d[6] + " layui-layer-btn-" + (a.btnAlign || "") + '">' + e + "</div>"
            }() : "") + (a.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], s, m('<div class="' + d.MOVE + '" id="' + d.MOVE + '"></div>')), this
        }, t.pt.creat = function () {
            var e, n = this, a = n.config, o = n.index, s = "object" == typeof (r = a.content), l = m("body");
            if (!a.id || !m("." + d[0]).find("#" + a.id)[0]) {
                switch (a.removeFocus && document.activeElement.blur(), "string" == typeof a.area && (a.area = "auto" === a.area ? ["", ""] : [a.area, ""]), a.shift && (a.anim = a.shift), 6 == h.ie && (a.fixed = !1), a.type) {
                    case 0:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        s || (a.content = [a.content, "body"]), a.follow = a.content[1], a.content = a.content[0] + '<i class="layui-layer-TipsG"></i>', delete a.title, a.tips = "object" == typeof a.tips ? a.tips : [a.tips, !0], a.tipsMore || h.closeAll("tips")
                }
                n.vessel(s, function (e, t, i) {
                    l.append(e[0]), s ? 2 == a.type || 4 == a.type ? m("body").append(e[1]) : r.parents("." + d[0])[0] || (r.data("display", r.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]), m("#" + d[0] + o).find("." + d[5]).before(t)) : l.append(e[1]), m("#" + d.MOVE)[0] || l.append(f.moveElem = i), n.layero = m("#" + d[0] + o), n.shadeo = m("#" + d.SHADE + o), a.scrollbar || d.html.css("overflow", "hidden").attr("layer-full", o)
                }).auto(o), n.shadeo.css({
                    "background-color": a.shade[1] || "#000",
                    opacity: a.shade[0] || a.shade
                }), 2 == a.type && 6 == h.ie && n.layero.find("iframe").attr("src", r[0]), 4 == a.type ? n.tips() : (n.offset(), parseInt(f.getStyle(document.getElementById(d.MOVE), "z-index")) || (n.layero.css("visibility", "hidden"), h.ready(function () {
            ...
            }], a.where[n - 1](), 1 === n ? a.top - (c.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === n ? 0 < c.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === n ? 0 < a.top - c.scrollTop() + a.height + i[1] + 16 - c.height() && a.where[0]() : 4 === n && 0 < i[0] + 16 - a.left && a.where[1](), t.find("." + d[5]).css({
            ...
            return a.move && t.css("cursor", "move"), t.on("mousedown", function (e) {
                var t, i;
                e.button || (t = m(this), i = {}, a.move && (i.layero = o, i.config = a, i.offset = [e.clientX - parseFloat(o.css("left")), e.clientY - parseFloat(o.css("top"))], t.data(r[0], i), f.eventMoveElem = t, f.moveElem.css("cursor", "move").show()), e.preventDefault())
            }), i.on("mousedown", function (e) {
                var t = m(this), i = {};
                a.resize && (i.layero = o, i.config = a, i.offset = [e.clientX, e.clientY], i.index = n.index, i.area = [o.outerWidth(), o.outerHeight()], t.data(r[1], i), f.eventResizeElem = t, f.moveElem.css("cursor", "se-resize").show()), e.preventDefault()
            }), f.docEvent || (e.on("mousemove", function (e) {
                var t, i, n, a, o, s, l;
                f.eventMoveElem && (t = (a = f.eventMoveElem.data(r[0]) || {}).layero, o = a.config, s = e.clientX - a.offset[0], l = e.clientY - a.offset[1], i = "fixed" === t.css("position"), e.preventDefault(), a.stX = i ? 0 : c.scrollLeft(), a.stY = i ? 0 : c.scrollTop(), o.moveOut || (i = c.width() - t.outerWidth() + a.stX, n = c.height() - t.outerHeight() + a.stY, i < (s = s < a.stX ? a.stX : s) && (s = i), n < (l = l < a.stY ? a.stY : l) && (l = n)), t.css({
                    left: s,
                    top: l
                })), f.eventResizeElem && (o = (a = f.eventResizeElem.data(r[1]) || {}).config, s = e.clientX - a.offset[0], l = e.clientY - a.offset[1], e.preventDefault(), h.style(a.index, {
                    width: a.area[0] + s,
                    height: a.area[1] + l
                }), o.resizing && o.resizing(a.layero))
            }).on("mouseup", function (e) {
                var t, i;
                f.eventMoveElem && (i = (t = f.eventMoveElem.data(r[0]) || {}).config, f.eventMoveElem.removeData(r[0]), delete f.eventMoveElem, f.moveElem.hide(), i.moveEnd && i.moveEnd(t.layero)), f.eventResizeElem && (f.eventResizeElem.removeData(r[1]), delete f.eventResizeElem, f.moveElem.hide())
            }), f.docEvent = !0), n
            ...
            }) : n.success(i, t.index, t)), 6 == h.ie && t.IE6(i), i.find("." + d[6]).children("a").on("click", function () {
                var e = m(this).index();
            ...
            var t, i, n;
            e && (t = h.getChildFrame("html", e).outerHeight(), i = (e = m("#" + d[0] + e)).find(d[1]).outerHeight() || 0, n = e.find("." + d[6]).outerHeight() || 0, e.css({height: t + i + n}), e.find("iframe").css({height: t}))
        }, h.iframeSrc = function (e, t) {
            m("#" + d[0] + e).find("iframe").attr("src", t)
        }, h.style = function (e, t, i) {
            var e = m("#" + d[0] + e), n = e.find(".layui-layer-content"), a = e.attr("type"),
            ...
            t = t || {};
            var i, n, a, o, s = m("#" + d[0] + e), l = s.data("maxminStatus");
            "min" !== l && ("max" === l && h.restore(e), s.data("maxminStatus", "min"), l = m("#" + d.SHADE + e), i = s.find(d[1]).outerHeight() || 0, n = s.attr("minLeft") || 181 * f.minIndex + "px", a = s.css("position"), o = {
                width: 180,
                height: i,
                position: "fixed",
                overflow: "hidden"
            }, f.record(s), f.minLeft[0] && (n = f.minLeft[0], f.minLeft.shift()), t.minStack && (o.left = n, o.top = c.height() - i, s.attr("minLeft") || f.minIndex++, s.attr("minLeft", n)), s.attr("position", a), h.style(e, o, !0), s.find(".layui-layer-min").hide(), "page" === s.attr("type") && s.find(d[4]).hide(), f.rescollbar(e), l.hide())
        }, h.restore = function (e) {
            var t = m("#" + d[0] + e), i = (t.data("maxminStatus", ""), m("#" + d.SHADE + e)),
                n = t.attr("area").split(",");
            t.attr("type");
            h.style(e, {
                width: n[0],
                ...
                overflow: "visible"
            }, !0), t.find(".layui-layer-max").removeClass("layui-layer-maxmin"), t.find(".layui-layer-min").show(), "page" === t.attr("type") && t.find(d[4]).show(), t.attr("minLeft", ""), f.rescollbar(e), i.show(), f.events.resize[e]()
        }, h.full = function (t) {
            var i = m("#" + d[0] + t), e = i.data("maxminStatus");
            "max" !== e && ("min" === e && h.restore(t), i.data("maxminStatus", "max"), f.record(i), d.html.attr("layer-full") || d.html.css("overflow", "hidden").attr("layer-full", t), clearTimeout(void 0), setTimeout(function () {
            ...
            var e, s, t,
                l = (e = m("." + d[0]).find("#" + a).closest("." + d[0]))[0] ? (a = e.attr("times"), e) : m("#" + d[0] + a),
                r = l.attr("type");
            l[0] && (s = "layui-layer-wrap", t = function () {
                if (r === f.type[1] && "object" === l.attr("conType")) {
                    ...
                    if (r === f.type[2]) try {
                        var i = m("#" + d[4] + a)[0];
                        i.contentWindow.document.write(""), i.contentWindow.close(), l.find("." + d[5])[0].removeChild(i)
                    } catch (n) {
                    }
                    l[0].innerHTML = "", l.remove()
                }
                "function" == typeof f.end[a] && f.end[a](), delete f.end[a], "function" == typeof o && o(), f.events.resize[a] && (c.off("resize", f.events.resize[a]), delete f.events.resize[a])
            }, l.data("isOutAnim") && l.addClass("layer-anim layer-anim-close"), m("#layui-layer-moves, #" + d.SHADE + a).remove(), 6 == h.ie && f.reselect(), f.rescollbar(a), l.attr("minLeft") && (f.minIndex--, f.minLeft.push(l.attr("minLeft"))), h.ie && h.ie < 10 || !l.data("isOutAnim") ? t() : setTimeout(function () {
                t()
            }, 200))
    ...
    h.prompt = function (i, n) {
        ...
        if ((n = n || {}).photos) {
            var t = !("string" == typeof n.photos || n.photos instanceof m), i = t ? n.photos : {}, s = i.data || [],
                l = i.start || 0, r = (o.imgIndex = 1 + (0 | l), n.img = n.img || "img", n.success);
...
layui.define("jquery", function (e) {
    "use strict";
    var s = layui.$, o = layui.hint(), a = {
        fixbar: function (i) {
            var a, e, t, n, o = "layui-fixbar", r = s(document), l = (i = s.extend(!0, {
                    target: "body",
                    bars: [],
                    "default": !0,
                    showHeight: 200,
                    duration: 200
                }, i), s(i.target)), c = i.scroll ? s(i.scroll) : s("body" === i.target ? r : l),
            ...
            layui.each(i.bars, function (e, t) {
                ...
                n.addClass(t.icon).attr({
                    ...
                    "top" === e && ("body" === i.target ? s("html,body") : c).animate({scrollTop: 0}, i.duration), "function" == typeof i.click && i.click.call(this, e)
                }), "object" === layui.type(i.on) && layui.each(i.on, function (e, t) {
                    n.on(e, function () {
                        var e = s(this).attr("lay-type");
                        "function" == typeof t && t.call(this, e)
                    })
                }), "top" === t.type && (n.addClass("layui-fixbar-top"), a = n), u.append(n)
            }), l.find("." + o).remove(), "object" == typeof i.css && u.css(i.css), l.append(u), a && (t = function t() {
                return c.scrollTop() >= i.showHeight ? e || (a.show(), e = 1) : e && (a.hide(), e = 0), t
            ...
            (e = s.extend({
                ...
                duration: 200,
                type: "y"
            }, e)).scrollElem[0] && e.thisElem[0] && (t = e.scrollElem, l = e.thisElem, i = (o = "y" === e.type) ? "top" : "left", a = t[n = o ? "scrollTop" : "scrollLeft"](), o = t[o ? "height" : "width"](), r = t.offset()[i], c = {}, ((l = l.offset()[i] - r) > o - e.margin || l < e.margin) && (c[n] = l - o / 2 + a, t.animate(c, e.duration)))
        }, event: function (n, i, e) {
            var t = s("body");
            return e = e || "click", i = a.event[n] = s.extend(!0, a.event[n], i) || {}, a.event.UTIL_EVENT_CALLBACK = a.event.UTIL_EVENT_CALLBACK || {}, t.off(e, "*[" + n + "]", a.event.UTIL_EVENT_CALLBACK[n]), a.event.UTIL_EVENT_CALLBACK[n] = function () {
                var e = s(this), t = e.attr(n);
...
layui.define(["jquery", "laytpl", "lay"], function (e) {
    "use strict";
    var t, i, n, s = layui.$, m = layui.laytpl, a = layui.hint(), o = layui.device().mobile ? "click" : "mousedown",
        r = "dropdown", c = "layui_" + r + "_index", p = {
        ...
        }, l = "layui-menu-item-up", d = "layui-menu-item-down", f = "layui-menu-body-title", u = "layui-menu-item-group",
        g = "layui-menu-item-parent", h = "layui-menu-item-checked", v = "layui-menu-item-checked2",
        w = "layui-menu-body-panel", C = "layui-menu-body-panel-left", V = "layui-dropdown-shade",
        k = "." + u + ">." + f, x = function (e) {
            var i = this;
    ...
    x.prototype.config = {
        ...
        var i = this, n = i.config, t = n.elem = s(n.elem);
        return 1 < t.length ? (layui.each(t, function () {
            p.render(s.extend({}, n, {elem: this}))
        }), i) : !e && t[0] && t.data(c) ? (t = y.getThis(t.data(c))) ? t.reload(n) : void 0 : (n.id = "id" in n ? n.id : i.index, n.show && i.render(e), void i.events())
    }, x.prototype.render = function (e) {
        var l = this, d = l.config, i = s("body"), u = function (r, e) {
                return layui.each(e, function (e, i) {
                    var n, t = i.child && 0 < i.child.length, a = ("isSpreadItem" in i ? i : d).isSpreadItem,
                        l = i.templet ? m(i.templet).render(i) : d.templet ? m(d.templet).render(i) : i.title,
                        o = (t && (i.type = i.type || "parent"), i.type ? {
                            group: "group",
                            parent: "parent",
                            "-": "-"
                        }[i.type] || "parent" : "");
                    ("-" === o || i.title || i.id || t) && ((l = s(["<li" + (n = {
                        group: "layui-menu-item-group" + (d.isAllowSpread ? a ? " layui-menu-item-down" : " layui-menu-item-up" : ""),
                        parent: g,
                        "-": "layui-menu-item-divider"
                    }, t || o ? ' class="' + n[o] + '"' : "") + ">", (n = "href" in i ? '<a href="' + i.href + '" target="' + (i.target || "_self") + '">' + l + "</a>" : l, t ? '<div class="' + f + '">' + n + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && d.isAllowSpread ? '<i class="layui-icon layui-icon-' + (a ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + f + '">' + n + "</div>"), "</li>"].join(""))).data("item", i), t && (a = s('<div class="layui-panel layui-menu-body-panel"></div>'), n = s("<ul></ul>"), "parent" === o ? (a.append(u(n, i.child)), l.append(a)) : l.append(u(n, i.child))), r.append(l))
                }), r
            },
            n = ['<div class="layui-dropdown layui-border-box layui-panel layui-anim layui-anim-downbit">', "</div>"].join("");
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(c + "_opened") || (l.elemView = s(n), l.elemView.append(d.content || (e = s('<ul class="layui-menu layui-dropdown-menu"></ul>'), 0 < d.data.length ? u(e, d.data) : e.html('<li class="layui-menu-item-none">no menu</li>'), e)), d.className && l.elemView.addClass(d.className), d.style && l.elemView.attr("style", d.style), p.thisId = d.id, l.remove(), i.append(l.elemView), d.elem.data(c + "_opened", !0), n = d.shade ? '<div class="' + V + '" style="z-index:' + (l.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "", l.elemView.before(n), l.position(), (y.prevElem = l.elemView).data("prevElem", d.elem), l.elemView.find(".layui-menu").on(o, function (e) {
            layui.stope(e)
        }), l.elemView.find(".layui-menu li").on("click", function (e) {
            var i = s(this), n = i.data("item") || {}, t = n.child && 0 < n.child.length, a = "all" === d.clickScope;
            t && !a || "-" === n.type || (t || l.remove(), "function" == typeof d.click && d.click(n, i), layui.stope(e))
    ...
    }, x.prototype.position = function (e) {
        var i = this.config;
        ...
        this.config;
        var e = y.prevElem;
        e && (e.data("prevElem") && e.data("prevElem").data(c + "_opened", !1), e.remove()), lay("." + V).remove()
    }, x.prototype.delayRemove = function () {
        ...
        "hover" === n.trigger && (n.trigger = "mouseenter"), i.prevElem && i.prevElem.off(n.trigger, i.prevElemCallback), i.prevElem = n.elem, i.prevElemCallback = function (e) {
            clearTimeout(y.timer), i.e = e, i.render(), e.preventDefault(), "function" == typeof n.ready && n.ready(i.elemView, n.elem, i.e.target)
        }, n.elem.on(n.trigger, i.prevElemCallback), "mouseenter" === n.trigger && n.elem.on("mouseleave", function () {
            i.delayRemove()
        })
    ...
    }, t = s(window), i = s(document), t.on("resize", function () {
        if (p.thisId) {
        ...
        var i, n;
        !p.thisId || (i = y.getThis(p.thisId)) && (n = i.config, !lay.isTopElem(n.elem[0]) && "contextmenu" !== n.trigger && (e.target === n.elem[0] || n.elem.find(e.target)[0] || e.target === i.elemView[0] || i.elemView && i.elemView.find(e.target)[0]) || i.remove())
    }), n = ".layui-menu:not(.layui-dropdown-menu) li", i.on("click", n, function (e) {
        var i = s(this), n = i.parents(".layui-menu").eq(0), t = i.hasClass(u) || i.hasClass(g),
            a = n.attr("lay-filter") || n.attr("id"), l = lay.options(this);
        i.hasClass("layui-menu-item-divider") || t || (n.find("." + h).removeClass(h), n.find("." + v).removeClass(v), i.addClass(h), i.parents("." + g).addClass(v), layui.event.call(this, r, "click(" + a + ")", l))
    }), i.on("click", n + k, function (e) {
        var i = s(this).parents("." + u + ":eq(0)"), n = lay.options(i[0]);
        "isAllowSpread" in n && !n.isAllowSpread || y.spread(i)
    }), n = ".layui-menu ." + g, i.on("mouseenter", n, function (e) {
        var i, n = s(this).find("." + w);
        n[0] && ((i = n[0].getBoundingClientRect()).right > t.width() && (n.addClass(C), (i = n[0].getBoundingClientRect()).left < 0 && n.removeClass(C)), i.bottom > t.height() && n.eq(0).css("margin-top", -(i.bottom - t.height() + 5)))
...
layui.define("jquery", function (e) {
    ...
    var g = layui.$, t = {
        ...
        }, a = "slider", c = "layui-disabled", x = "layui-slider-bar", b = "layui-slider-wrap", T = "layui-slider-wrap-btn",
    ...
    i.prototype.config = {
        ...
        var a, n = this, l = n.config,
            ...
            i = '<div class="layui-slider ' + ("vertical" === l.type ? "layui-slider-vertical" : "") + '">' + (l.tips ? '<div class="' + w + '"></div>' : "") + '<div class="layui-slider-bar" style="background:' + e + "; " + ("vertical" === l.type ? "height" : "width") + ":" + t + ";" + ("vertical" === l.type ? "bottom" : "left") + ":" + (i || 0) + ';"></div><div class="layui-slider-wrap" style="' + ("vertical" === l.type ? "bottom" : "left") + ":" + (i || t) + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + e + ';"></div></div>' + (l.range ? '<div class="layui-slider-wrap" style="' + ("vertical" === l.type ? "bottom" : "left") + ":" + s + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + e + ';"></div></div>' : "") + "</div>",
            t = g(l.elem), s = t.next(".layui-slider");
        if (s[0] && s.remove(), n.elemTemp = g(i), l.range ? (n.elemTemp.find("." + b).eq(0).data("value", l.value[0]), n.elemTemp.find("." + b).eq(1).data("value", l.value[1])) : n.elemTemp.find("." + b).data("value", l.value), t.html(n.elemTemp), "vertical" === l.type && n.elemTemp.height(l.height + "px"), l.showstep) {
        ...
        l.input && !l.range && (e = g('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div>'), t.css("position", "relative"), t.append(e), t.find("." + M).children("input").val(l.value), "vertical" === l.type ? e.css({
            left: 0,
            top: -48
        }) : n.elemTemp.css("margin-right", e.outerWidth() + 15)), l.disabled ? (n.elemTemp.addClass(c), n.elemTemp.find("." + T).addClass(c)) : n.slide(), n.elemTemp.find("." + T).on("mouseover", function () {
            var e = "vertical" === l.type ? l.height : n.elemTemp[0].offsetWidth, i = n.elemTemp.find("." + b),
                t = ("vertical" === l.type ? e - g(this).parent()[0].offsetTop - i.height() : g(this).parent()[0].offsetLeft) / e * 100,
                i = g(this).parent().data("value"), e = l.setTips ? l.setTips(i) : i;
        ...
        var o = this, r = o.config, u = o.elemTemp, d = function () {
                return "vertical" === r.type ? r.height : u[0].offsetWidth
            }, c = u.find("." + b), m = u.next(".layui-slider-input"), v = m.children("." + M).children("input").val(),
            p = 100 / ((r.max - r.min) / Math.ceil(r.step)), f = function (e, i, t) {
                ...
                var a, n = h(c[0].offsetLeft), l = r.range ? h(c[1].offsetLeft) : 0,
                    ...
                    n = Math.abs(n - l), l = ("vertical" === r.type ? u.find("." + x).css({
                        height: n + "%",
                        bottom: s + "%"
                    }) : u.find("." + x).css({width: n + "%", left: s + "%"}), r.min + Math.round((r.max - r.min) * e / 100));
                ...
                var i = e / d() * 100 / p, t = Math.round(i) * p;
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var m = layui.$, t = layui.lay, o = layui.hint(), i = layui.device().mobile ? "click" : "mousedown", n = {
        ...
        P = "layui-icon-close", C = "layui-colorpicker-trigger-span", B = "layui-colorpicker-trigger-i",
        w = "layui-colorpicker-side-slider", I = "layui-colorpicker-basis", D = "layui-colorpicker-alpha-bgcolor",
        E = "layui-colorpicker-alpha-slider", F = "layui-colorpicker-basis-cursor", M = "layui-colorpicker-main-input",
        T = function (e) {
            ...
            var e = Y(e), o = [e.r.toString(16), e.g.toString(16), e.b.toString(16)];
    ...
    d.prototype.config = {
        ...
        var e = this, i = e.config, o = m(i.elem);
        if (1 < o.length) return layui.each(o, function () {
            n.render(m.extend({}, i, {elem: this}))
        }), e;
        m.extend(i, t.options(o[0]));
        var o = m(['<div class="layui-unselect layui-colorpicker">', "<span " + ("rgb" == i.format && i.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : "") + ">", '<span class="layui-colorpicker-trigger-span" ', 'lay-type="' + ("rgb" == i.format ? i.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + (o = "", i.color ? (o = i.color, 3 < (i.color.match(/[0-9]{1,3}/g) || []).length && (i.alpha && "rgb" == i.format || (o = "#" + j(T(L(i.color))))), "background: " + o) : o) + '">', '<i class="layui-icon layui-colorpicker-trigger-i ' + (i.color ? x : P) + '"></i>', "</span>", "</span>", "</div>"].join("")),
            r = i.elem = m(i.elem);
        i.size && o.addClass("layui-colorpicker-" + i.size), r.addClass("layui-inline").html(e.elemColorBox = o), i.id = "id" in i ? i.id : e.index, e.color = e.elemColorBox.find("." + C)[0].style.background, e.events()
        ...
        var n = this, l = n.config, c = n.elemColorBox.find("." + C), a = c.attr("lay-type"),
            s = n.elemPicker.find(".layui-colorpicker-side"), e = n.elemPicker.find("." + w),
            d = n.elemPicker.find("." + I), r = n.elemPicker.find("." + F), f = n.elemPicker.find("." + D),
            u = n.elemPicker.find("." + E), g = e[0].offsetTop / 180 * 360, h = 100 - (r[0].offsetTop + 3) / 180 * 100,
            p = (r[0].offsetLeft + 3) / 260 * 100, v = Math.round(u[0].offsetLeft / 280 * 100) / 100,
            b = n.elemColorBox.find("." + B), i = n.elemPicker.find(".layui-colorpicker-pre").children("div"),
            y = function (e, i, o, r) {
                n.select(e, i, o);
                var t = Y({h: e, s: i, b: o}), e = j({h: e, s: i, b: o}), i = n.elemPicker.find("." + M).find("input");
        ...
        e.on("mousedown", function (e) {
            ...
            m(this).on("click", function () {
                ...
                var e = this.style.backgroundColor, i = T(L(e)), o = e.slice(e.lastIndexOf(",") + 1, e.length - 1);
                g = i.h, p = i.s, h = i.b, 3 == (e.match(/[0-9]{1,3}/g) || []).length && (o = 1), v = o, y(i.h, i.s, i.b, o)
            })
        })
    }, d.prototype.select = function (e, i, o, r) {
        this.config;
        var t = j({h: e, s: 100, b: 100}), e = (j({h: e, s: i, b: o}), e / 360 * 180), o = 180 - o / 100 * 180 - 3,
            i = i / 100 * 260 - 3;
        this.elemPicker.find("." + w).css("top", e), this.elemPicker.find("." + I)[0].style.background = "#" + t, this.elemPicker.find("." + F).css({
            top: o,
            left: i
        })
        ...
        var c = this, a = c.config, s = c.elemColorBox.find("." + C), d = c.elemPicker.find("." + M + " input"), o = {
            clear: function (e) {
                s[0].style.background = "", c.elemColorBox.find("." + B).removeClass(x).addClass(P), c.color = "", a.done && a.done(""), c.removePicker()
            }, confirm: function (e, i) {
                var o, r, t = d.val(), n = t, l = {};
                if (-1 < t.indexOf(",") ? (l = T(L(t)), c.select(l.h, l.s, l.b), s[0].style.background = n = "#" + j(l), 3 < (t.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (o = 280 * t.slice(t.lastIndexOf(",") + 1, t.length - 1), c.elemPicker.find("." + E).css("left", o), n = s[0].style.background = t)) : (3 == (o = -1 < (o = t).indexOf("#") ? o.substring(1) : o).length && (o = (r = o.split(""))[0] + r[0] + r[1] + r[1] + r[2] + r[2]), r = {
                    r: (o = parseInt(o, 16)) >> 16,
                    g: (65280 & o) >> 8,
                    b: 255 & o
                }, l = T(r), s[0].style.background = n = "#" + j(l), c.elemColorBox.find("." + B).removeClass(P).addClass(x)), "change" === i) return c.select(l.h, l.s, l.b, i), void (a.change && a.change(n));
...
layui.define(["lay", "layer"], function (e) {
    "use strict";
    var v = layui.$, t = layui.layer, y = layui.device(), i = {
        ...
        }, n = "upload", a = "layui-upload-file", o = "layui-upload-form", F = "layui-upload-iframe",
    ...
    x.prototype.config = {
        ...
        var e = this, t = e.config,
            i = e.elemFile = v(['<input class="' + a + '" type="file" accept="' + t.acceptMime + '" name="' + t.field + '"', t.multiple ? " multiple" : "", ">"].join("")),
            n = t.elem.next();
        (n.hasClass(a) || n.hasClass(o)) && n.remove(), y.ie && y.ie < 10 && t.elem.wrap('<div class="layui-upload-wrap"></div>'), e.isFile() ? (e.elemFile = t.elem, t.field = t.elem[0].name) : t.elem.after(i), y.ie && y.ie < 10 && e.initIE()
    }, x.prototype.initIE = function () {
        var i, e = this.config,
            t = v('<iframe id="' + F + '" class="' + F + '" name="' + F + '" frameborder="0"></iframe>'),
            n = v(['<form target="' + F + '" class="' + o + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">', "</form>"].join(""));
        v("#" + F)[0] || v("body").append(t), e.elem.next().hasClass(o) || (this.elemFile.wrap(n), e.elem.next("." + o).append((i = [], layui.each(e.data, function (e, t) {
        ...
        var n, a, t, o, l = this, r = l.config, c = l.elemFile[0], u = function () {
            var t = 0, a = 0, e = i || l.files || l.chooseFiles || c.files, o = function () {
                r.multiple && t + a === l.fileLength && "function" == typeof r.allDone && r.allDone({
                    total: l.fileLength,
                    successful: t,
                    failed: a
                })
            ...
            layui.each(e, function (i, e) {
                var n = new FormData, e = (layui.each(r.data, function (e, t) {
            ...
            if (l.elemFile.next("." + b).remove(), c.value = "", "json" === r.force && "object" != typeof t) try {
                t = JSON.parse(t)
            } catch (i) {
        ...
        }, d = r.exts, m = (a = [], layui.each(i || l.chooseFiles, function (e, t) {
            a.push(t.name)
        }), a), h = {
            preview: function (e) {
                l.preview(e)
            ...
            video: "\u89c6\u9891",
            audio: "\u97f3\u9891"
        }[r.accept] || "\u6587\u4ef6", m = 0 === m.length ? c.value.match(/[^\/\\]+\..+/g) || [] || "" : m;
        if (0 !== m.length) {
            switch (r.accept) {
                case"file":
            ...
            if (n) return l.msg("\u9009\u62e9\u7684" + g + "\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"), c.value = "";
            if ("choose" !== e && !r.auto || (r.choose && r.choose(h), "choose" !== e)) {
                if (l.fileLength = (t = 0, g = i || l.files || l.chooseFiles || c.files, layui.each(g, function () {
                    t++
                ...
                if (0 < r.size && !(y.ie && y.ie < 10)) if (layui.each(l.chooseFiles, function (e, t) {
                    t.size > 1024 * r.size && (t = 1 <= (t = r.size / 1024) ? t.toFixed(2) + "MB" : r.size + "KB", c.value = "", o = t)
        ...
        var n = this, a = n.config, o = function (e) {
            ...
            var i = n.elemFile,
                e = (a.item || a.elem, 1 < e.length ? e.length + "\u4e2a\u6587\u4ef6" : (e[0] || {}).name || i[0].value.match(/[^\/\\]+\..+/g) || [] || "");
            i.next().hasClass(b) && i.next().remove(), n.upload(null, "choose"), n.isFile() || a.choose || i.after('<span class="layui-inline ' + b + '">' + e + "</span>")
        }, r = function () {
            var e = v(this);
            (e.attr("lay-data") || e.attr("lay-options")) && (n.config = v.extend({}, a, lay.options(this, {attr: e.attr("lay-data") ? "lay-data" : null})))
        };
...
layui.define(["layer", "util"], function (e) {
    ...
    var C = layui.$, h = layui.layer, d = layui.util, l = layui.hint(), w = (layui.device(), "form"), o = ".layui-form",
        T = "layui-this", $ = "layui-hide", F = "layui-disabled", t = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "\u5fc5\u586b\u9879\u4e0d\u80fd\u4e3a\u7a7a"],
            ...
            var i = this.config, a = C(o + (t ? '[lay-filter="' + t + '"]' : "")), n = {
                input: function (e) {
                    ...
                    i.autocomplete && e.attr("autocomplete", i.autocomplete), a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                        var i = C(this), a = i.attr("lay-affix"), n = i.next(".layui-input-suffix"),
                            e = i.is("[disabled]") || i.is("[readonly]"), l = function (e, t) {
                                e && e[C.trim(t) ? "removeClass" : "addClass"]($)
                            }, r = function (e, t) {
                                n.remove(), n = C(['<div class="layui-input-suffix layui-input-affix-event"' + (t ? " disabled" : "") + ">", '<i class="layui-icon layui-icon-' + e + (t ? " layui-disabled" : "") + '"></i>', "</div>"].join("")), i.after(n), l(n, i.val()), i.on("input propertychange", function () {
                                    var e = this.value;
                                    l(n, e)
                                }), n.on("click", function () {
                                    var e = i.attr("lay-filter");
                                    C(this).is("[disabled]") || (s[a] && s[a][1].call(this), layui.event.call(this, w, "input-affix(" + e + ")", {
                                        elem: i[0],
                                        affix: a
                                    }))
                                })
                                ...
                                clear: [function () {
                                    ...
                                    i.val("").focus(), l(n, null)
                                }], eye: [function () {
                                    r("eye-invisible")
                                }, function () {
                                    var e = "LAY_FORM_INPUT_AFFIX_SHOW", t = i.data(e);
                                    i.attr("type", t ? "password" : "text").data(e, !t), r(t ? "eye-invisible" : "eye")
                                }]
                            };
                        s[a] && s[a][0]()
                    })
                    ...
                    var p, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", g = "layui-select-title",
                        x = "layui-select-none", k = "", e = e || a.find("select"), b = function (e, t) {
                            ...
                            e || (r = c.attr("lay-search"), i = function () {
                                var e = a.offset().top + a.outerHeight() + 5 - E.scrollTop(), t = f.outerHeight();
                                v = c[0].selectedIndex, a.addClass(m + "ed"), h.removeClass($), y.removeClass($), s = null, h.removeClass(T), 0 <= v && h.eq(v).addClass(T), e + t > E.height() && t <= e && a.addClass(m + "up"), o()
                            }, n = function (e) {
                                ...
                                var e = l.keyCode, r = (9 === e && n(), function (a, n) {
                                    ...
                                    var e = function () {
                                        ...
                                        if (f.children("dd." + $)[0] && "next" === a) {
                                            var t = f.children("dd:not(." + $ + ",." + F + ")"), i = t.eq(0).index();
                                            if (0 <= i && i < e.index() && !t.hasClass(T)) return t.eq(0).prev()[0] ? t.eq(0).prev() : f.children(":last")
                                        }
                                        return n && n[0] ? n : s && s[0] ? s : e
                                    }(), t = e[a](), i = e[a]("dd:not(." + $ + ")");
                                    return t[0] ? (s = e[a](), i[0] && !i.hasClass(F) || !s[0] ? (i.addClass(T).siblings().removeClass(T), void o()) : r(a, s)) : s = null
                                });
                                ...
                                }, "keyup"), "" === t && f.find("." + x).remove(), o()
                            }).on("blur", function (e) {
                                var t = c[0].selectedIndex;
                                p = d, k = C(c[0].options[t]).html(), 0 === t && k === d.attr("placeholder") && (k = ""), setTimeout(function () {
                                    l(d.val(), function (e) {
                                        k || d.val("")
                                    }, "blur")
                                }, 200)
                                ...
                                return e.hasClass(F) || (e.hasClass("layui-select-tips") ? d.val("") : (d.val(e.text()), e.addClass(T)), e.siblings().removeClass(T), c.val(t).removeClass("layui-form-danger"), layui.event.call(this, w, "select(" + i + ")", {
                                    elem: c[0],
                                    value: t,
                                    othis: a
                                }), n(!0)), !1
                    ...
                    e.each(function (e, t) {
                        ...
                        var s, o = "string" == typeof i.attr("lay-search"), t = t && !t.value && t.innerHTML || c,
                            r = C(['<div class="' + (o ? "" : "layui-unselect ") + m, (n ? " layui-select-disabled" : "") + '">', '<div class="' + g + '">', '<input type="text" placeholder="' + d.escape(C.trim(t)) + '" value="' + d.escape(C.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + F : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (t = i.find("*"), s = [], layui.each(t, function (e, t) {
                                ...
                                0 !== e || t.value || "optgroup" === i ? "optgroup" === i ? s.push("<dt>" + t.label + "</dt>") : s.push('<dd lay-value="' + d.escape(t.value) + '" class="' + (l === t.value ? T : "") + (t.disabled ? " " + F : "") + '">' + C.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + C.trim(t.innerHTML || c) + "</dd>")
                    ...
                    e.each(function (e, t) {
                        ...
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        var s = i.next("." + r[0]),
                            t = C(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + F : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (l = {
                                checkbox: [t.title.replace(/\s/g, "") ? "<span>" + d.escape(t.title) + "</span>" : "", '<i class="layui-icon layui-icon-ok"></i>'].join(""),
                    ...
                    e.each(function (e, t) {
                        ...
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        a[0] && a.remove();
                        n = C(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '">', '<i class="layui-anim layui-icon">' + s[t.checked ? 0 : 1] + "</i>", "<div>" + (a = d.escape(t.title || ""), a = "string" == typeof i.next().attr("lay-radio") ? i.next().html() : a) + "</div>", "</div>"].join(""));
        ...
        }), r = new t, t = C(document), E = C(window);
    C(function () {
        r.render()
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    "use strict";
    var v = layui.$, r = layui.lay, g = layui.laytpl, F = layui.laypage, b = layui.layer, y = layui.form,
        x = layui.util, f = layui.hint(), p = layui.device(), k = {
            config: {
            ...
            return i && (m.that[i] = a, m.config[i] = e), {
            ...
            var t = this.config || {}, a = (e = e || {}).item3, i = e.content,
                t = (("escape" in a ? a : t).escape && (i = x.escape(i)), e.text && a.exportTemplet || a.templet || a.toolbar);
            return t && (i = "function" == typeof t ? t.call(a, e.tplData, e.obj) : g(v(t).html() || String(i)).render(v.extend({LAY_COL: a}, e.tplData))), e.text ? v("<div>" + i + "</div>").text() : i
        }, T = "table", t = ".layui-table", L = "layui-hide", o = "layui-hide-v", d = "layui-none", N = "layui-table-view",
        c = ".layui-table-header", D = ".layui-table-body", s = ".layui-table-pageview", W = ".layui-table-sort",
        A = "layui-table-edit", E = "layui-table-hover", M = "laytable-cell-group", _ = "layui-table-col-special",
        j = "layui-table-tool-panel", R = "LAY_TABLE_MOVE_DICT", a = function (e) {
        ...
        H = v(window), S = v(document), n = function (e) {
            ...
            var t = this, a = t.config;
            if (a.elem = v(a.elem), a.where = a.where || {}, a.id = "id" in a ? a.id : a.elem.attr("id") || t.index, a.request = v.extend({
                pageName: "page",
                limitName: "limit"
            ...
            a.index = t.index, t.key = a.id || a.index, t.setInit(), a.height && /^full-\d+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = H.height() - t.fullHeightGap) : a.height && /^#\w+\S*-\d+$/.test(a.height) && (e = a.height.split("-"), t.parentHeightGap = e.pop(), t.parentDiv = e.join("-"), a.height = v(t.parentDiv).height() - t.parentHeightGap);
            var i, e = a.elem, l = e.next("." + N), n = t.elem = v("<div></div>");
            n.addClass((i = [N, N + "-" + t.index, "layui-form", "layui-border-box"], a.className && i.push(a.className), i.join(" "))).attr({
            ...
            r.height = r.maxHeight || r.height, r.css && -1 === r.css.indexOf(N) && (a = r.css.split("}"), layui.each(a, function (e, t) {
                t && (a[e] = "." + N + "-" + d.index + " " + t)
            }), r.css = a.join("}"));
            var c = function (a, e, i, l) {
                var n, o;
                l ? (l.key = [r.index, a, i].join("-"), l.hide = l.hide || !1, l.colspan = l.colspan || 0, l.rowspan = l.rowspan || 0, d.initOpts(l), (n = a + (parseInt(l.rowspan) || 1)) < r.cols.length ? (l.colGroup = !0, o = 0, layui.each(r.cols[n], function (e, t) {
            ...
            var e = this.config,
                ...
                i = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = v(e.toolbar).html() || "") && a.html(g(t).render(e)), {
                    filter: {
                        title: "\u7b5b\u9009\u5217",
            ...
            var e, t = this.config, a = this.layPagebar = v('<div class="layui-inline layui-table-pagebar"></div>');
            t.pagebar && ((e = v(t.pagebar).html() || "") && a.append(g(e).render(t)), this.layPage.append(a))
        }, n.prototype.setParentCol = function (e, t) {
            var a = this.config, i = this.layHeader.find('th[data-key="' + t + '"]'), l = parseInt(i.attr("colspan")) || 0;
            i[0] && (t = t.split("-"), t = a.cols[t[1]][t[2]], e ? l-- : l++, i.attr("colspan", l), i[1 <= l || !e ? "removeClass" : "addClass"](L), t.colspan = l, t.hide = 1 <= l || !e, (a = i.data("parentkey")) && this.setParentCol(e, a))
            ...
            var e, l = this;
            l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + M)).css("width", 0), layui.each(e.get().reverse(), function () {
                var e = v(this), t = e.parent().data("key"), a = 0;
                l.layHeader.eq(0).find("th[data-parentkey=" + t + "]").width(function (e, t) {
                    v(this).hasClass(L) || 0 < t && (a += t)
                }), a && e.css("max-width", a), i && e.parent().data("parentkey") && l.setGroupWidth(e.parent())
            }), e.css("width", "auto"))
            ...
            0 < n.autoColNums && -i <= l && l <= i && (e = (a = (t = function (e) {
                return !(e = e || n.layHeader.eq(0).find("thead th:last-child")).data("field") && e.prev()[0] ? t(e.prev()) : e
            ...
            var t = this, a = t.layMain.find("." + d), e = v('<div class="' + d + '">' + (e || "Error") + "</div>");
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(L), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(o), t.layPage.find(s).addClass(o), k.cache[t.key] = [], t.syncCheckAll()
        }, n.prototype.page = 1, n.prototype.pullData = function (t, a) {
            var e, i = this, l = i.config, n = l.request, o = l.response, d = function () {
                "object" == typeof l.initSort && i.sort(l.initSort.field, l.initSort.type)
            };
            a = a || {}, "function" == typeof l.before && l.before(l), i.startTime = (new Date).getTime(), l.url ? ((e = {})[n.pageName] = t, e[n.limitName] = l.limit, n = v.extend(e, l.where), l.contentType && 0 == l.contentType.indexOf("application/json") && (n = JSON.stringify(n)), i.loading(), v.ajax({
                type: l.method || "get",
                url: l.url,
                ...
                success: function (e) {
                    (e = "function" == typeof l.parseData ? l.parseData(e) || e : e)[o.statusName] != o.statusCode ? (i.renderForm(), i.errorView(e[o.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + o.statusName + '": ' + o.statusCode)) : (i.renderData({
                        ...
                        count: e[o.countName],
                        type: a.type
                    }), d(), l.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof l.done && l.done(e, t, e[o.countName])
                },
                error: function (e, t) {
                    i.errorView("\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a" + t), i.renderForm(), i.setColsWidth(), "function" == typeof l.error && l.error(e, t)
                }
            })) : "array" === layui.type(l.data) && (e = t * l.limit - l.limit, (n = {})[o.dataName] = l.data.concat().splice(e, l.limit), n[o.countName] = l.data.length, "object" == typeof l.totalRow && (n[o.totalRowName] = v.extend({}, l.totalRow)), i.renderData({
                res: n,
                curr: t,
                count: n[o.countName],
                type: a.type
            ...
            var u = this, h = u.config, t = e.res, l = e.curr, a = e.count, n = e.sort, y = t[h.response.dataName] || [],
                t = t[h.response.totalRowName], f = [], p = [], m = [], i = function () {
                    var s;
                    if (h.HAS_SET_COLS_PATCH || u.setColsPatch(), h.HAS_SET_COLS_PATCH = !0, !n && u.sortKey) return u.sort(u.sortKey.field, u.sortKey.sort, !0);
                    layui.each(y, function (o, d) {
                        var a = [], i = [], r = [], c = o + h.limit * (l - 1) + 1;
                        if ("object" != typeof d) {
                            y[o] = d = {LAY_KEY: d};
                            try {
                                k.cache[u.key][o] = d
                        ...
                        "array" === layui.type(d) && 0 === d.length || (d[k.config.numbersName] = c, n || (d[k.config.indexName] = o), u.eachCols(function (e, l) {
                            var e = l.field || e, t = l.key, n = d[e];
                            n !== undefined && null !== n || (n = ""), l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + t + '" ' + (e = [], l.edit && e.push('data-edit="true"'), l.templet && e.push('data-content="' + x.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (e = [], l.hide && e.push(L), l.field || e.push(_), e.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? t : t + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function () {
                                var e, t = v.extend(!0, {LAY_COL: l}, d), a = k.config.checkName, i = k.config.disabledName;
                                switch (l.type) {
                                    case"checkbox":
            ...
            return k.cache[u.key] = y, u.layTotal[0 == y.length ? "addClass" : "removeClass"](o), u.layPage[h.page || h.pagebar ? "removeClass" : "addClass"](L), u.layPage.find(s)[!h.page || 0 == a || 0 === y.length && 1 == l ? "addClass" : "removeClass"](o), 0 === y.length ? (u.renderForm(), u.errorView(h.text.none)) : (u.layFixLeft.removeClass(L), n ? i() : (i(), u.renderTotal(y, t), u.layTotal && u.layTotal.removeClass(L), void (h.page && (h.page = v.extend({
                ...
                jump: function (e, t) {
                    t || (u.page = e.curr, h.limit = e.limit, u.pullData(e.curr))
                }
            }, h.page), h.page.count = a, F.render(h.page)))))
            ...
            c.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field],
                    l = (a = t.totalRowText || "", n = "totalRowDecimals" in t ? t.totalRowDecimals : 2, n = parseFloat(s[e]).toFixed(n), (l = {LAY_COL: t})[e] = n, n = t.totalRow && w.call(r, {
                        item3: t,
                        content: n,
                        tplData: l
                    }) || a, i || n),
        ...
        }, n.prototype.sort = function (l, e, t, a) {
            var i, n = this, o = {}, d = n.config, r = d.elem.attr("lay-filter"), c = k.cache[n.key];
            "string" == typeof l && (s = l, n.layHeader.find("th").each(function (e, t) {
                var a = v(this), i = a.data("field");
                if (i === l) return l = a, s = i, !1
            }));
            try {
                var s = s || l.data("field"), u = l.data("key");
                if (n.sortKey && !t && s === n.sortKey.field && e === n.sortKey.sort) return;
                var h = n.layHeader.find("th .laytable-cell-" + u).find(W);
                n.layHeader.find("th").find(W).removeAttr("lay-sort"), h.attr("lay-sort", e || null), n.layFixed.find("th")
            } catch (y) {
            ...
            n.sortKey = {
                field: s,
                sort: e
            }, d.autoSort && ("asc" === e ? i = layui.sort(c, s) : "desc" === e ? i = layui.sort(c, s, !0) : (i = layui.sort(c, k.config.indexName), delete n.sortKey, delete d.initSort)), o[d.response.dataName] = i || c, n.renderData({
                res: o,
                curr: n.page,
                count: n.count,
                sort: !0
                ...
                field: s,
                type: e
            }, layui.event.call(l, T, "sort(" + r + ")", v.extend({config: d}, d.initSort)))
        }, n.prototype.loading = function (e) {
            var t = this;
            t.config.loading && (e ? (t.layInit && t.layInit.remove(), delete t.layInit, t.layBox.find(".layui-table-init").remove()) : (t.layInit = v(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>', "</div>"].join("")), t.layBox.append(t.layInit)))
        }, n.prototype.setCheckData = function (e, t) {
            var a = this.config, i = k.cache[this.key];
            ...
            t[0] && (k.checkStatus(e.key).isAll ? (t[0].checked || (t.prop("checked", !0), e.renderForm("checkbox")), a(!0)) : (t[0].checked && (t.prop("checked", !1), e.renderForm("checkbox")), a(!1)))
            ...
            i.fullHeightGap ? (l = H.height() - i.fullHeightGap, i.elem.css("height", l = l < 135 ? 135 : l)) : i.parentDiv && i.parentHeightGap && (l = v(i.parentDiv).height() - i.parentHeightGap, i.elem.css("height", l = l < 135 ? 135 : l)), 1 < t.cols.length && (e = i.layFixed.find(c).find("th"), a = i.layHeader.first(), layui.each(e, function (e, t) {
                (t = v(t)).height(a.find('th[data-key="' + t.attr("data-key") + '"]').height() + "px")
            })), l && (e = parseFloat(l) - (i.layHeader.outerHeight() || 38), t.toolbar && (e -= i.layTool.outerHeight() || 50), t.totalRow && (e -= i.layTotal.outerHeight() || 40), (t.page || t.pagebar) && (e -= i.layPage.outerHeight() || 43), t.maxHeight ? layui.each({
                elem: l,
                layMain: e
            }, function (e, t) {
            ...
            var e = this, t = e.layMain.children("table"), a = e.layMain.width() - e.layMain.prop("clientWidth"),
                ...
                l = (e.getScrollWidth(e.layMain[0]), t.outerWidth() - e.layMain.width()), n = function (e) {
                    var t;
                    a && i ? (e = e.eq(0)).find(".layui-table-patch")[0] || ((t = v('<th class="layui-table-patch"><div class="layui-table-cell"></div></th>')).find("div").css({width: a}), e.find("tr").append(t)) : e.find(".layui-table-patch").remove()
                };
            n(e.layHeader), n(e.layTotal);
            n = e.layMain.height() - i;
            e.layFixed.find(D).css("height", t.height() >= n ? n : "auto"), e.layFixRight[0 < l ? "removeClass" : "addClass"](L), e.layFixRight.css("right", a - 1)
        }, n.prototype.events = function () {
            var s = this, u = s.config, r = u.elem.attr("lay-filter"), e = s.layHeader.find("th"), h = ".layui-table-cell",
                n = v("body"), o = {}, d = (s.layTool.on("click", "*[lay-event]", function (e) {
                    var a, i = v(this), t = i.attr("lay-event"), l = function (e) {
                        var t = v(e.list), a = v('<ul class="' + j + '"></ul>');
                    ...
                    switch (layui.stope(e), S.trigger("table.tool.panel.remove"), b.close(s.tipsIndex), t) {
                        case"LAYTABLE_COLS":
                            l({
                                list: (a = [], s.eachCols(function (e, t) {
                                    t.field && "normal" == t.type && a.push('<li><input type="checkbox" name="' + t.field + '" data-key="' + t.key + '" data-parentkey="' + (t.parentKey || "") + '" lay-skin="primary" ' + (t.hide ? "" : "checked") + ' title="' + x.escape(v("<div>" + (t.fieldTitle || t.title || t.field) + "</div>").text()) + '" lay-filter="LAY_TABLE_TOOL_COLS"></li>')
                                }), a.join("")), done: function () {
                                    y.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = v(e.elem), t = this.checked, a = e.data("key"), i = s.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, s.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](L), l != i.hide && s.setParentCol(!t, e), s.resize(), layui.event.call(this, T, "colToggled(" + r + ")", {
                                            col: i,
                                            config: u
                                        }))
                                    })
                        ...
                        case"LAYTABLE_EXPORT":
                            p.ie ? b.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", this, {tips: 3}) : l({
                        ...
                        case"LAYTABLE_PRINT":
                            ...
                            d.append(s.layMain.find("table").html()), d.append(s.layTotal.find("table").html()), d.find("th.layui-table-patch").remove(), d.find("thead>tr>th." + _).filter(function (e, t) {
                                return !v(t).children("." + M).length
                            }).remove(), d.find("tbody>tr>td." + _).remove(), n.document.write(o + d.prop("outerHTML")), n.document.close(), n.print(), n.close()
                    }
                    layui.event.call(this, T, "toolbar(" + r + ")", v.extend({event: t, config: u}, {}))
                }), s.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = v(this).attr("lay-event");
                    layui.event.call(this, T, "pagebar(" + r + ")", v.extend({event: t, config: u}, {}))
                }), e.on("mousemove", function (e) {
                    var t = v(this), a = t.offset().left, e = e.clientX - a;
                    t.data("unresize") || m.eventMoveElem || (o.allowResize = t.width() - e <= 10, n.css("cursor", o.allowResize ? "col-resize" : ""))
                }).on("mouseleave", function () {
                    v(this);
                    m.eventMoveElem || n.css("cursor", "")
                }).on("mousedown", function (e) {
                    var t, a = v(this);
                    o.allowResize && (t = a.data("key"), e.preventDefault(), o.offset = [e.clientX, e.clientY], s.getCssRule(t, function (e) {
                        var t = e.style.width || a.outerWidth();
                        o.rule = e, o.ruleWidth = parseFloat(t), o.minWidth = a.data("minwidth") || u.cellMinWidth, o.maxWidth = a.data("maxwidth") || u.cellMaxWidth
                    }), a.data(R, o), m.eventMoveElem = a)
                }), m.docEvent || S.on("mousemove", function (e) {
                    var t, a;
                    m.eventMoveElem && (t = m.eventMoveElem.data(R) || {}, m.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule && (e = t.ruleWidth + e.clientX - t.offset[0], a = m.eventMoveElem.closest("." + N).attr("lay-id"), (a = C(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(m.eventMoveElem), b.close(s.tipsIndex))))
                }).on("mouseup", function (e) {
                    var t, a, i, l;
                    m.eventMoveElem && (i = (t = m.eventMoveElem).closest("." + N).attr("lay-id"), (a = C(i)) && (i = t.data("key"), l = a.col(i), o = {}, n.css("cursor", ""), a.scrollPatch(), t.removeData(R), delete m.eventMoveElem, a.getCssRule(i, function (e) {
                        l.width = parseFloat(e.style.width), layui.event.call(t[0], T, "colResized(" + r + ")", {
                            col: l,
                            config: a.config
                        })
                    })))
                }), m.docEvent = !0, e.on("click", function (e) {
                    var t = v(this), a = t.find(W), i = a.attr("lay-sort");
                    ...
                    var t = v(this), a = t.index(), t = t.parents("th").eq(0).data("field");
                    layui.stope(e), 0 === a ? s.sort(t, "asc", null, !0) : s.sort(t, "desc", null, !0)
                }), s.commonMember = function (e) {
                    var t = v(this).parents("tr").eq(0).data("index"), r = s.layBody.find('tr[data-index="' + t + '"]'),
                        c = (c = k.cache[s.key] || [])[t] || {};
                    return v.extend({
                        tr: r, config: u, data: k.clearCacheKey(c), del: function () {
                            k.cache[s.key][t] = [], r.remove(), s.scrollPatch()
                        }, update: function (e, d) {
                            e = e || {}, layui.each(e, function (i, l) {
                                var n = r.children('td[data-field="' + i + '"]'), o = n.children(h);
                                i in c && (c[i] = l), s.eachCols(function (e, t) {
                                    var a;
                                    t.field == i ? (o.html(w.call(s, {
                                        item3: t,
                                        content: l,
                                        tplData: v.extend({LAY_COL: t}, c)
                                    })), n.data("content", l)) : d && (t.templet || t.toolbar) && (e = r.children('td[data-field="' + (t.field || e) + '"]'), a = c[t.field], e.children(h).html(w.call(s, {
                                        item3: t,
                                        content: a,
                                        tplData: v.extend({LAY_COL: t}, c)
                                    })), e.data("content", a))
                    ...
                    var e = v(this).prev(), t = s.layBody.find('input[name="layTableCheckbox"]'),
                    ...
                    }), s.syncCheckAll(), s.renderForm("checkbox")) : (s.setCheckData(a, i), s.syncCheckAll()), layui.event.call(e[0], T, "checkbox(" + r + ")", d.call(e[0], {
                        checked: i,
                        type: l ? "all" : "one"
                    })))
                }), s.elem.on("click", 'input[lay-type="layTableRadio"]+', function () {
                    var e = v(this).prev(), t = e[0].checked, a = k.cache[s.key], i = e.parents("tr").eq(0).data("index");
                    layui.each(a, function (e, t) {
                        i === e ? t[u.checkName] = !0 : delete t[u.checkName]
                    }), s.setThisRowChecked(i), layui.event.call(this, T, "radio(" + r + ")", d.call(this, {checked: t}))
                }), s.layBody.on("mouseenter", "tr", function () {
                    var e = v(this), t = e.index();
                    ...
                    var t = v(this);
                    t.data("off") || layui.event.call(this, T, e + "(" + r + ")", d.call(t.children("td")[0]))
                }), c = function (e, t) {
                    var a, i, l, n;
                    (e = v(e)).data("off") || (a = e.data("field"), n = e.data("key"), n = s.col(n), i = e.closest("tr").data("index"), i = k.cache[s.key][i], l = e.children(h), (n = "function" == typeof n.edit ? n.edit(i) : n.edit) && ((n = v("textarea" === n ? '<textarea class="layui-input ' + A + '"></textarea>' : '<input class="layui-input ' + A + '">'))[0].value = e.data("content") || i[a] || l.text(), e.find("." + A)[0] || e.append(n), n.focus(), t && layui.stope(t)))
                }, i = (s.layBody.on("change", "." + A, function () {
                    var e = v(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = k.cache[s.key][e], l = d.call(t[0], {
                    ...
                    var t = v(this).parent().children(h);
                    s.tipsIndex = b.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (t.height() + 23) + "px;" + ("sm" === u.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === u.size ? "padding: 14px 15px;" : "") + '">', t.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), t[0], {
                        tips: [3, ""],
                        time: -1,
                        anim: -1,
                    ...
                    var t = v(this), a = t.parents("tr").eq(0).data("index");
                    layui.event.call(this, T, (e || "tool") + "(" + r + ")", d.call(this, {event: t.attr("lay-event")})), s.setThisRowChecked(a)
                });
            s.layBody.on("click", "*[lay-event]", function (e) {
                ...
                var e = v(this), t = e.scrollLeft(), e = e.scrollTop();
                s.layHeader.scrollLeft(t), s.layTotal.scrollLeft(t), s.layFixed.find(D).scrollTop(e), b.close(s.tipsIndex)
            }), H.on("resize", function () {
                s.resize()
            })
        }, S.on("click", function () {
            ...
            o = o || {};
            var e = v(i ? 'table[lay-filter="' + i + '"]' : t + "[lay-data], " + t + "[lay-options]"),
                d = "Table element property lay-data configuration item has a syntax error: ";
            return e.each(function () {
                var l, e = v(this), t = e.attr("lay-data"),
                    ...
                    n = v.extend({
                        ...
                        n.cols[i] = [], v(this).children().each(function (e) {
                            var t = v(this), a = t.attr("lay-data"),
                ...
                !a.length || o.data || t.config.url || (l = 0, k.eachCols(t.config.id, function (e, i) {
                    a.each(function (e) {
                        n.data[e] = n.data[e] || {};
                        var t = v(this), a = i.field;
                        n.data[e][a] = t.children("td").eq(l).html()
                    }), l++
                }), t.reloadData({data: n.data}))
            }), this
        }, m.that = {}, m.config = {}, function (a, i, e, l) {
            var n, o;
            l.colGroup && (n = 0, a++, l.CHILD_COLS = [], o = e + (parseInt(l.rowspan) || 1), layui.each(i[o], function (e, t) {
                t.parentKey ? t.parentKey === l.key && (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), u(a, i, o, t)) : t.PARENT_COL_INDEX || 1 <= n && n == (l.colspan || 1) || (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), n += t.hide ? 0 : parseInt(1 < t.colspan ? t.colspan : 1), u(a, i, o, t))
            }))
        });
    k.eachCols = function (e, a, i) {
        var e = m.config[e] || {}, l = [], n = (i = v.extend(!0, [], i || e.cols), layui.each(i, function (a, e) {
            if (a) return !0;
            layui.each(e, function (e, t) {
        ...
        return layui.each(e, function (e, t) {
            "array" === layui.type(t) ? i++ : t[k.config.checkName] && (a++, t[k.config.disabledName] || l.push(k.clearCacheKey(t)))
        ...
        var d, i, l, r, n = (a = "object" == typeof a ? a : (n = {}, a && (n.type = a), n)).type || "csv",
            c = m.that[e], o = m.config[e] || {}, s = {csv: "text/csv", xls: "application/vnd.ms-excel"}[n],
            u = document.createElement("a");
        if (p.ie) return f.error("IE_NOT_SUPPORT_EXPORTS");
        u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((d = [], i = [], l = [], r = {}, layui.each(t, function (l, n) {
            ...
            "object" == typeof e ? (layui.each(e, function (e, t) {
                0 == l && d.push(t || "")
            }), layui.each(layui.isArray(n) ? v.extend([], n) : k.clearCacheKey(n), function (e, t) {
                o.push('"' + (t || "") + '"')
            })) : k.eachCols(e, function (e, t) {
                var a, i;
                t.field && "normal" == t.type && (t.hide ? 0 == l && (r[t.field] = !0) : (a = n[t.field], i = c.layBody.find('tr[data-index="' + l + '"]>td'), a !== undefined && null !== a || (a = ""), 0 == l && d.push(t.fieldTitle || t.title || t.field || ""), o.push('"' + w.call(c, {
                    item3: t,
                    content: a,
                    tplData: n,
                    text: "text",
        ...
        e ? l(e) && C(e).resize() : layui.each(m.that, function () {
            this.resize()
        })
    }, k.reload = function (e, t, a, i) {
        if (l(e)) return e = C(e), e.reload(t, a, i), m.call(e)
        ...
        return delete (e = v.extend({}, e))[k.config.checkName], delete e[k.config.indexName], delete e[k.config.numbersName], delete e[k.config.disabledName], e
        ...
        n && ("boolean" === layui.type(l) ? n.eachCols(function (e, t) {
            ...
            i.hide != l && (i = i.hide = l, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](L), n.setParentCol(i, t))
        }) : layui.each(l, function (e, l) {
            n.eachCols(function (e, t) {
                var a, i;
                l.field === t.field && (a = t.key, i = n.col(a), t = t.parentKey, "hide" in l && i.hide != l.hide && (i = i.hide = !!l.hide, n.elem.find('*[data-key="' + a + '"]')[i ? "addClass" : "removeClass"](L), n.setParentCol(i, t)))
            })
        }), v("." + j).remove(), n.resize())
    }, v(function () {
        k.init()
...
layui.define("jquery", function (e) {
    ...
    var a = layui.$, n = (layui.hint(), layui.device(), {
        ...
        c = "layui-carousel-prev", m = "layui-carousel-next", t = "layui-carousel-arrow", o = "layui-carousel-ind",
        i = function (e) {
            var i = this;
    ...
    i.prototype.config = {
        ...
        n.elem.attr("lay-indicator", n.indicator), n.elem.find("." + o)[0] && n.elem.find("." + o).remove(), n.elem.append(t), "updown" === n.anim && t.css("margin-top", -t.height() / 2), t.find("li").on("hover" === n.trigger ? "mouseover" : n.trigger, function () {
            e.jump(a(this).index())
        })
...
layui.define(["lay", "util"], function (e) {
    ...
    e("code", function (e) {
        ...
        e.elem = d(e.elem), e.elem[0] && layui.each(e.elem.get().reverse(), function (e, l) {
            var a, t = d(l), i = (i = t.html(), d.trim(i).replace(/^\n|\n$/, "")),
                l = d.extend({}, c, lay.options(l), (a = {}, layui.each(["title", "height", "encode", "skin", "about"], function (e, l) {
                    var i = t.attr("lay-" + l);
                    "string" == typeof i && (a[l] = i)
                }), a)), s = l.ln ? "ol" : "ul", s = d("<" + s + ' class="layui-code-' + s + '">'),
                n = d('<div class="' + u + '">');
            t.addClass("layui-code-view layui-box"), l.skin && ("notepad" === l.skin && (l.skin = "dark"), t.addClass("layui-code-" + l.skin)), i = (i = l.encode ? o.escape(i) : i).replace(/[\r\t\n]+/g, "</li><li>"), t.html(s.html("<li>" + i + "</li>")), t.children("." + u)[0] || (n.html(l.title + (l.about ? '<div class="layui-code-about">' + l.about + "</div>" : "")), t.prepend(n)), 0 < (i = Math.floor(s.find("li").length / 100)) && s.css("margin-left", i + "px"), l.height && s.css("max-height", l.height)
        })
    })
